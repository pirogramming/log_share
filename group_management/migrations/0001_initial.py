# Generated by Django 2.2.9 on 2020-02-21 10:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('access_code', models.CharField(blank=True, max_length=50, verbose_name='그룹가입코드')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='group_GroupRequest', to='group_management.CustomGroup')),
                ('sender', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_GroupRequest', to=settings.AUTH_USER_MODEL)),
            ],
            options={
